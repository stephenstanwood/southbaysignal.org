...
export const DATA_VERIFIED_AT = "2026-04-24";
...
export const CAMPS: Camp[] = [
  ...
  // ─── Sunnyvale — city ──────────────────────────────────────────────────────
  {
    ...
    priceNote: "Pricing inside the Sunnyvale WebTrac catalog (registration opened Apr 6) — call 408-730-7350 for quotes by phone.",
    notes: "Multiple tracks: Traditional, Sports, STEM, and Teen Camps.",
  ...
  // ─── Mountain View — city ──────────────────────────────────────────────────
  {
    ...
    priceNote: "Pricing inside the MV Recreation catalog (resident registration opened Mar 7, 2026). Call (650) 903-6331 for quotes.",
  ...
  // ─── Campbell — city ───────────────────────────────────────────────────────
  {
    ...
    priceNote: "2026 Rec1 catalog: Day Camp Teeter Totters (ages 2.5–5.5) $157/wk · full-day camps and specialty sessions observed $215–$512/wk (median $350).",
    notes: "Runs Jun 15 – Aug 7. Registration via Rec1 catalog (secure.rec1.com/CA/campbell-ca/catalog).",
    weeks: [wk(2, 350), wk(3, 350), wk(4, 350), wk(5, 350), wk(6, 350), wk(7, 350), wk(8, 350), wk(9, 350)],
  },
  ...
  // ─── Cupertino — city ──────────────────────────────────────────────────────
  {
    ...
    priceNote: "Sports track via Lifetime Activities (2026 schedule): All-day tennis/basketball/chess/pickleball $599 resident · half-day $369 · Little Ballers (ages 4–6) $263. Other tracks (art, STEM, nature) vary — check the cupertino.gov catalog.",
    notes: "Runs Jun 8 – Aug 7. Multiple providers across sports, arts, and STEM tracks.",
    weeks: [
  ...
  // ─── Milpitas — city (two distinct camps) ──────────────────────────────────
  {
    ...
    priceNote: "Pricing inside the Milpitas ActiveNet catalog — call Milpitas Rec for quotes.",
  ...
  // ─── Los Gatos + Saratoga — joint rec ──────────────────────────────────────
  {
    ...
    priceNote: "8 themed Clubhouse Day Camps (Jun 8 – Jul 31) plus Enrichment, Sports, Aquatics, and Boating tracks. Prices inside the PerfectMind catalog — click 'Show' next to a week.",
  ...
  // ─── Los Altos — city ──────────────────────────────────────────────────────
  {
    ...
    priceNote: "2026 Redwood Grove sessions observed at $198–$300/wk in the Los Altos Rec1 catalog.",
    notes: "Register via secure.rec1.com/CA/LosAltosRecreation/catalog.",
    weeks: [wk(3, 242), wk(4, 242), wk(5, 242), wk(6, 242), wk(7, 242), wk(8, 242), wk(9, 242), wk(10, 242)],
  },
...

  {
    ...
    priceNote: "Stanford R&WE page still listed Summer 2025 as of Apr 2026 — call (650) 723-4591 to confirm 2026 dates and rates before registering.",
...

  {
    ...
    priceNote: "Get an instant quote on the public Dates & Rates tool at jsv.campintouch.com/ui/unrestricted/pricing/DatesAndRates — pick grade, member status, and session.",
    notes: "First day Jun 8. Dedicated site at campshalomjcc.org.",
