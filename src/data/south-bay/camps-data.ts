...
export const CAMPS: Camp[] = [
  ...
  // ─── Campbell — city ───────────────────────────────────────────────────────
  {
    ...
    priceNote: "2026 Rec1 catalog: Day Camp Teeter Totters (ages 2.5–5.5) $157/wk · full-day camps and specialty sessions range up to ~$500/wk.",
  ...
  // ─── Los Altos — city ──────────────────────────────────────────────────────
  {
    ...
    priceNote: "2026 Redwood Grove sessions observed at $198–$300 in the Los Altos Rec1 catalog.",
...

  {
    ...
    notes: "As of Apr 2026 the Stanford R&WE page still advertised Summer 2025 — call (650) 723-4591 to confirm 2026 session dates before registering.",
    weeks: [wk(3, null), wk(4, null), wk(5, null), wk(6, null), wk(7, null), wk(8, null), wk(9, null), wk(10, null)],
  },
