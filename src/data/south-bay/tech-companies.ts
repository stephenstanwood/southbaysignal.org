...
export const TECH_MILESTONES: TechMilestone[] = [
  {
    ...
    anniversaryNote: "Apple celebrates its {ordinal} anniversary this month. From a Cupertino garage to a $3 trillion company, it's the most consequential story in Silicon Valley history.",
  ...
  },
  {
    ...
    anniversaryNote: "On April 19, 1965, Gordon Moore published 'Cramming more components onto integrated circuits' in Electronics magazine while working at Fairchild Semiconductor in Mountain View. His prediction — that chip density would double roughly every two years — became the metronome of the entire tech industry for 60+ years. Moore later co-founded Intel in Santa Clara. This year marks the {ordinal} anniversary of the paper that defined Silicon Valley's ambition.",
