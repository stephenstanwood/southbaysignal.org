...
export const TECH_MILESTONES: TechMilestone[] = [
  {
    ...
    anniversaryNote: "Apple celebrates its {ordinal} anniversary this month. From a Cupertino garage to the first company ever valued at $3 trillion, it's the most consequential story in Silicon Valley history.",
...
export const TECH_CONFERENCES: TechConference[] = [
  ...
  },
  {
    ...
    typicalDay: 12,
    typicalEndDay: 15,
    description: "The Open Compute Project's four-day annual gathering at the San Jose Convention Center, where its community presents open hardware and software work spanning racks, cooling, interconnects, and AI data centers.",
