...
export const SOUTH_BAY_EVENTS: SBEvent[] = [
...

  {
    ...
    address: "E. Campbell Ave between Central Ave & 3rd St, Campbell",
    category: "market",
    recurrence: "weekly",
    days: ["sunday"],
    time: "9am – 1pm",
    ...
    kidFriendly: true,
    description:
      "Year-round downtown market with produce, flowers, honey, specialty foods, and artisan goods. Rain or shine; EBT and WIC accepted, with Market Match dollars on fruit and vegetables. Closed for Oktoberfest weekend.",
  ...
  {
    id: "santa-clara-farmers-market",
    title: "Santa Clara Farmers Market",
    city: "santa-clara",
    venue: "Jackson St & Homestead Rd",
    address: "Jackson St & Homestead Rd, Santa Clara",
    category: "market",
    recurrence: "weekly",
    days: ["saturday"],
    time: "9am – 1pm",
    ...
    kidFriendly: true,
    description:
      "Year-round Saturday market at Jackson and Homestead, run by the same association behind the Sunnyvale, Campbell, and Willow Glen markets. Rain or shine; WIC, Veggie Rx, and Beet Bucks accepted.",
    url: "https://uvfm.org/santa-clara-saturdays",
    emoji: "🍅",
  },
  {
