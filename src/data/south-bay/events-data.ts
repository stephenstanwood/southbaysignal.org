...
export const SOUTH_BAY_EVENTS: SBEvent[] = [
  ...
  {
    id: "campbell-library-storytime-tue",
    title: "Campbell Library Story Time",
    city: "campbell",
    ...
    cost: "free",
    kidFriendly: true,
    description: "Free weekly story time for babies, toddlers, and preschoolers. No registration required.",
    url: "https://www.sccl.org/campbell",
    emoji: "📚",
    startDate: "2026-05-09", // library closed for renovation; reopens May 9 2026
  },
  {
    id: "campbell-library-storytime-wed",
    title: "Campbell Library Story Time",
    city: "campbell",
    venue: "Campbell Library",
    address: "77 Harrison Ave, Campbell",
  ...
  {
    id: "campbell-library-storytime-thu",
    title: "Campbell Library Story Time",
    city: "campbell",
    venue: "Campbell Library",
    address: "77 Harrison Ave, Campbell",
